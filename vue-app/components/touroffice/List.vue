...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            ...mapGetters({
                deletedItem: 'touroffice/del/deleted',
                errorList: 'touroffice/list/error',
                errorCreate: 'touroffice/create/error',
                errorUpdate: 'touroffice/update/updateError',
                errorDelete: 'touroffice/del/error',
                items: 'touroffice/list/items',
                loading: 'touroffice/list/loading',
                view: 'touroffice/list/view',
                created: 'touroffice/create/created',
                deleteLoading: 'touroffice/del/loading',
                updateLoading: 'touroffice/update/updateLoading',
                createLoading: 'touroffice/create/loading'
            })
        },
        watch: {
            dialog(val) {
        ...
        methods: {
            ...
            deleteItem(item) {
                ...
                if (confirm('Are you sure you want to delete?')) {
                    ...
                    this.$store.dispatch('touroffice/del/delete', item).then(
                        () => {
                            if (this.flag) {
                                this.flag = false;
                                return;
            ...
            save() {
                ...
                if (this.editedIndex > -1) {
                    ...
                    this.$store.dispatch('touroffice/update/update', {
                    ...
                    this.$store.dispatch('touroffice/create/create', itemAux).then(
                        () => {
                            if (this.flag) {
                                this.flag = false;
                                return;
