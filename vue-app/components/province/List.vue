...
<script>
    ...
    export default {
        ...
        computed: {
            formTitle() {
                return this.editedIndex === -1 ? 'New Province' : 'Edit Province: '
            },
            ...mapGetters({
                deletedItem: 'province/del/deleted',
                errorList: 'province/list/error',
                errorCreate: 'province/create/error',
                errorUpdate: 'province/update/updateError',
                errorDelete: 'province/del/error',
                items: 'province/list/items',
                loading: 'province/list/loading',
                view: 'province/list/view',
                created: 'province/create/created',
                deleteLoading: 'province/del/loading',
                updateLoading: 'province/update/updateLoading',
                createLoading: 'province/create/loading'
            })
        },
        watch: {
            dialog(val) {
        ...
        methods: {
            ...
            deleteItem(item) {
                ...
                if (confirm('Are you sure you want to delete?')) {
                    ...
                    this.$store.dispatch('province/del/delete', item).then(
                        () => {
                            if (this.flag) {
                                this.flag = false;
                                return;
            ...
            save() {
                ...
                if (this.editedIndex > -1) {
                    ...
                    this.$store.dispatch('province/update/update', {
                    ...
                    this.$store.dispatch('province/create/create', itemAux).then(
                        () => {
                            if (this.flag) {
                                this.flag = false;
                                return;
